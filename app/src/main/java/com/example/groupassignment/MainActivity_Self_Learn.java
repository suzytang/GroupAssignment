        ...
        if (id == R.id.settings) {
            ...
            changeLanguage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    checkDialog = new Dialog(MainActivity_Self_Learn.this);
                    ...
                    yes.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(MainActivity_Self_Learn.this, LanguageActivity.class);
            ...
            info.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Dialog for credits
                    dialog = new Dialog(MainActivity_Self_Learn.this);
